...
(ii) Em seguinda, ainda no terminal, digite pyinstaller --onefile Uma_luz_na_escuridao_ilustrada.py
...
caminho = []        #Variável responsável por armazenar o caminho que 0 personagem trilhou até o momento
